                  ...
                  itemBuilder: (context, position) {
                    return Card(
                      ...
                      child: ListTile(
                          ...
                          title: Text(snapshot.data![position]['REGION_NAME']),
                          onTap: (){
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                backgroundColor: Colors.lightGreen,
                                content: Text(snapshot.data![position]['REGION_NAME']+" Region.", style: const TextStyle(fontWeight: FontWeight.bold),)),);
                          }
                      ),
                    );
                  },
...
//    List<Region>()
    ...
    } on SocketException{ //this is a specific exception being caught
      // if server cannot be reached socket exception is thrown
      return Future.error("SocketException: Sorry We Couldn't Connect to the Server");
